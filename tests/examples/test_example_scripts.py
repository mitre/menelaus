...
Note that the git workflow will have converted these from the most recent 
version of the .ipynb files in docs/source/examples.
"""
...
def test_script_execution(script):
    ...
    output_files = (
        pathlib.Path(__file__, "..", "..").resolve().rglob(output_file_pattern)
    )
