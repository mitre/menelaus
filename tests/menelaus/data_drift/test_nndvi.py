...
def test_nndvi_init():
    """Test correct default initialization for NN-DVI"""
    det = NNDVI()
    assert det.k_nn == 30
...
def test_nndvi_set_reference():
    """Assert NN-DVI.set_reference works as intended"""
    det = NNDVI()
...
def test_nndvi_update_1():
    """Ensure NN-DVI can update with small random batches"""
...
def test_nndvi_update_2():
    """Ensure NN-DVI can update with drift actions triggered"""
