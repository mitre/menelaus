...
class QuantTreePartitioner:
    """
    This class encapsulates a Quant Tree for partitioning data which runs
    through drift detection algorithms.
    ...
    def __init__(self, num_bins, target_probabilities):
        """
        Args:
            stuff
        """
